...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/error-page3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Sep 2023 10:03:42 GMT -->
...
<head>
    ...
    <title>{{ config('app.name') }} - Error @yield('title') </title>
    <!-- Google font-->
