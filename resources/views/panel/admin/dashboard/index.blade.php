...
@section('content')
    ...
    <div class="container-fluid default-dash">
        <div class="row">
                            ...
                            <table class="table table-bordernone">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="media">
                                                <img class="img-fluid me-3 b-r-5"
                                        ...
                                        <td>
                                            <span class="badge badge-light-theme-light font-theme-light">1 day ago</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span class="badge badge-light-theme-light font-theme-light">2 weeks ago</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span class="badge badge-light-theme-light font-theme-light">3 day ago</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span class="badge badge-light-theme-light font-theme-light">2 hours ago</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="square-box me-2">
                                                    <img class="img-fluid b-r-5" src="../assets/images/avtar/boy.png"
                                                        alt="">
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media">
                                                <div class="square-box me-2">
                                                    <img class="img-fluid b-r-5" src="../assets/images/avtar/girl.png"
                                                        alt="">
                                                </div>
                                                <div class="media-body ps-2">
                                                    <div class="avatar-details">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media">
                                                <div class="square-box me-2">
                                                    <img class="img-fluid b-r-5" src="../assets/images/avtar/man.png"
                                                        alt="">
                                                </div>
                                                <div class="media-body ps-2">
                                                    <div class="avatar-details">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media">
                                                <div class="square-box me-2">
                                                    <img class="img-fluid b-r-5" src="../assets/images/avtar/woman.png"
                                                        alt="">
                                                </div>
                                                <div class="media-body ps-2">
                                                    <div class="avatar-details">
            ...
            {{-- dari sini sampe bawah kerjaanya zahrina 😘 --}}
                            ...
                            <table class="table table-bordernone">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><span class="badge badge-light-theme-light font-theme-light">2 hours ago
                                            </span></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div class="media">
                                                ...
                                                <div class="media-body"><a href="user-profile.html">
                                                    ...
                                                    <p>Comment on <span class="font-primary">Vegetarian food fest</span>
                                                    </p>
                                        ...
                                        <td> <span class="badge badge-light-theme-light font-theme-light">10 jul
                                                2020</span></td>
                                    </tr>
                                    <tr>
                                        <td>
                                                    ...
                                                    <div class="my-gallery" itemscope="">
                                                        <div class="row gallery">
                                                            <figure class="inner-img ms-3" itemprop="associatedMedia"
                                                                itemscope=""><a
                                                                    href="../assets/images/dashboard/img-26.png"
                                                                    itemprop="contentUrl" data-size="600x600"><img
                                                                        class="img-fluid"
                                                                        src="../assets/images/dashboard/img-26.png"
