                        ...
                        <div class="col-md row">
                            <div class="col-md-6">
                                ...
                                <input required id="nama_ayah" type="text" class="form-control" name="nama_ayah"
                                    placeholder="Masukkan Nama Bapak" value="{{ $data->nama_ayah }}">
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="row mb-2">
                        <div class="col-md">
                            ...
                            <select required class="form-select select2" id="layanan" name="layanan"
                                ...
                                <option value="{{ $data->layanan }}" selected disabled>{{ $data->layanan }}</option>
                        ...
                        <div class="col-md d-none" id="col_sub_layanan">
                            ...
                            <select required class="form-select select2" id="sub_layanan" name="sub_layanan"
                                ...
                                <option value="{{ $data->sub_layanan }}" selected disabled>{{ $data->sub_layanan }}
                                </option>
                                @foreach ($layanan as $data)
                                    <option value="{{ $data['id'] }}">{{ $data['layanan'] }}</option>
                                @endforeach
                        ...
                        <div class="col-md">
                            ...
                            <select required class="form-select text-capitalize select2" id="support_teacher"
                                ...
                                <option value="{{ $data->support_teacher }}" selected disabled>
                                    {{ $data->support_teacher }}</option>
                    ...
                    <div class="row mb-2">
                        <div class="col-md">
                            ...
                            <input required id="tgl_masuk" type="date" class="form-control" name="tgl_masuk"
                                placeholder="Masukkan Tanggal Masuk" value="{{ $data->tgl_masuk }}">
                        </div>
                        <div class="col-md">
                            ...
                            <input required id="tgl_selesai" type="date" class="form-control" name="tgl_selesai"
                                placeholder="Masukkan Tanggal Masuk" value="{{ $data->tgl_selesai }}">
                        </div>
                        <div class="col-md">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-6" id="col_uang_bayar">
                            ...
                            <input id="uang_bayar" type="number" class="form-control" name="uang_bayar"
                                placeholder="Masukkan Uang Bayar" value="{{ $data->uang_bayar }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-md">
                            ...
                            <textarea required id="keluhan" type="text" rows="4" class="form-control" name="keluhan"
                                placeholder="Masukkan Keluhan"> {{ $data->keluhan }}</textarea>
                        </div>
                    </div>
                </div>
